    ...
    <div className="flex justify-center px-5 py-7 bg-white">
      <div className="w-full px-5 py-7">
        ...
        <div className="flex justify-center w-full">
          <div className="m-5 w-60 bg-white border-solid border-2 rounded-md shadow-md px-5 py-7">
          ...
          <div className=" w-60 m-5 bg-white border-solid border-2 rounded-md shadow-md px-5 py-7">
